...
static inline struct radio_pdu_node_tx *isr_rx_conn_pkt_release(struct radio_pdu_node_tx *node_tx)
{
    struct connection *conn = _radio.conn_curr;
...
#if defined(CONFIG_BT_CTLR_CONN_PARAM_REQ)
static inline void isr_rx_conn_pkt_ctrl_rej_conn_upd(struct radio_pdu_node_rx *radio_pdu_node_rx,
        u8_t *rx_enqueue)
{
...
#if defined(CONFIG_BT_CTLR_DATA_LENGTH)
static inline void isr_rx_conn_pkt_ctrl_rej_dle(struct radio_pdu_node_rx *radio_pdu_node_rx,
        u8_t *rx_enqueue)
{
    struct pdu_data_llctrl_reject_ext_ind *rej_ext_ind;
    struct pdu_data *pdu_data_rx;
...
#if defined(CONFIG_BT_CTLR_PHY)
static inline void isr_rx_conn_pkt_ctrl_rej_phy_upd(struct radio_pdu_node_rx *radio_pdu_node_rx,
        u8_t *rx_enqueue)
{
    struct pdu_data_llctrl_reject_ext_ind *rej_ext_ind;
    struct pdu_data *pdu_data_rx;
...
static inline void isr_rx_conn_pkt_ctrl_rej(struct radio_pdu_node_rx *radio_pdu_node_rx,
        u8_t *rx_enqueue)
{
    if (0)
    {
...
static inline u8_t isr_rx_conn_pkt_ctrl(struct radio_pdu_node_rx *radio_pdu_node_rx,
                                        u8_t *rx_enqueue)
{
    struct pdu_data *pdu_data_rx;
    u8_t nack = 0;
...
static inline u32_t isr_rx_conn_pkt(struct radio_pdu_node_rx *radio_pdu_node_rx,
