...
static inline struct net_6lo_context *get_6lo_context_by_cid(struct net_if *iface, u8_t cid)
{
    u8_t i;
...
static inline struct net_6lo_context *get_6lo_context_by_addr(struct net_if *iface, struct in6_addr *addr)
{
    u8_t i;
