# Makefile for eyesee-mpp/external/SQLiteCpp
CUR_PATH := .
PACKAGE_TOP := ..
...
LOCAL_TARGET_DYNAMIC := libSQLiteCpp
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libSQLiteCpp
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) -fPIC -Wall -fexceptions
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) -fPIC -Wall -fexceptions
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-external-SQLiteCpp done
	@echo ===================================
