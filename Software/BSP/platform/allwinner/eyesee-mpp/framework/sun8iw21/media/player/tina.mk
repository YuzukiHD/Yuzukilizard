...
LOCAL_CFLAGS := $(CFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -D__OS_LINUX -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-label
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -D__OS_LINUX -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-label
