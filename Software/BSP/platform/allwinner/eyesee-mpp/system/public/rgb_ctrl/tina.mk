# Makefile for eyesee-mpp/system/public/rgb_ctrl
CUR_PATH := .
PACKAGE_TOP := ..
...
INCLUDE_DIRS := \
    $(CUR_PATH) \
    $(CUR_PATH)/../include \
    $(EYESEE_MPP_INCLUDE)/external/lz4-1.7.5/lib
...
LOCAL_TARGET_DYNAMIC := librgb_ctrl
LOCAL_TARGET_STATIC := librgb_ctrl
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-system-rgb_ctrl done
	@echo ===================================
