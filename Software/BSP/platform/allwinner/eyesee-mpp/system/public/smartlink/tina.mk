# Makefile for eyesee-mpp/system/public/smartlink
CUR_PATH := .
...
LOCAL_TARGET_DYNAMIC := libsmartlink
LOCAL_TARGET_STATIC := libsmartlink
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-system-smartlink done
	@echo ===================================
