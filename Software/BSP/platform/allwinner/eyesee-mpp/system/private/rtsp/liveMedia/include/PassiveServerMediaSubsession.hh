...
typedef void(StartStreamCallback)(unsigned int clientSessionId);
...
public:
  ...
  void setStartStreamCallback(StartStreamCallback *function);
...
private:
  ...
  StartStreamCallback *_doStartStream;
};
