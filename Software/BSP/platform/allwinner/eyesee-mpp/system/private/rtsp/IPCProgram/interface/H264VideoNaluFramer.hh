...
class H264VideoNaluFramer : public H264or5VideoStreamDiscreteFramer {
  public:
    static H264VideoNaluFramer* createNew(UsageEnvironment& env, FramedSource* inputSource);

  protected:
    H264VideoNaluFramer(UsageEnvironment& env, FramedSource* inputSource);
    // called only by createNew()
    virtual ~H264VideoNaluFramer();
