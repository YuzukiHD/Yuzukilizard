#ifndef __SAMPLE_VENC_GDCZOOM_CONF_H__
#define __SAMPLE_VENC_GDCZOOM_CONF_H__
...
#define CFG_EnableGdcZoom  "enable_gdc_zoom"

#define CFG_TEST_DURATION  "test_duration"

#endif //#define __SAMPLE_VENC_GDCZOOM_CONF_H__
