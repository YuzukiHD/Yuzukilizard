...
LOCAL_PREBUILT_LIBS_PATH :=
ifeq ($(MPPCFG_TOOLCHAIN_LIBC), musl)
	LOCAL_PREBUILT_LIBS_PATH += $(CUR_PATH)/library/musl
else ifeq ($(MPPCFG_TOOLCHAIN_LIBC), glibc)
	LOCAL_PREBUILT_LIBS_PATH += $(CUR_PATH)/library/glibc
endif

#set dst file name: shared library, static library, execute bin.
LOCAL_TARGET_DYNAMIC := $(basename $(notdir $(wildcard $(LOCAL_PREBUILT_LIBS_PATH)/*.so)))
LOCAL_TARGET_STATIC := $(basename $(notdir $(wildcard $(LOCAL_PREBUILT_LIBS_PATH)/*.a)))
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	...
	@echo ===================================
$(target_dynamic) $(target_static): $(CUR_PATH)/out/%: $(LOCAL_PREBUILT_LIBS_PATH)/%
