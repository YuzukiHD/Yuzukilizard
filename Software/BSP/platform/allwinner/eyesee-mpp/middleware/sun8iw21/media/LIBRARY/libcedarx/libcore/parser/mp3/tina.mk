# Makefile for eyesee-mpp/middleware/media/LIBRARY/libcedarx/libcore/parser/mp3
CUR_PATH := .
PACKAGE_TOP := ../../../../../..
...
LOCAL_TARGET_STATIC := libcdx_mp3_parser
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(CEDARX_CFLAGS) $(inc_paths) -fPIC -Wall -D__OS_LINUX
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(CEDARX_CFLAGS) $(inc_paths) -fPIC -Wall -D__OS_LINUX
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libcedarx-libcore-parser-mp3 done
	@echo ===================================
