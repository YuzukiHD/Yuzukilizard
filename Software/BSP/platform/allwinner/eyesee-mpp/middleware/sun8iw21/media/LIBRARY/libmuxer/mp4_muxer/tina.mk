...
LOCAL_EXT_CFLAGS :=
ifeq ($(MPPCFG_GPS_PACK_IN_TRACK),Y)
  LOCAL_EXT_CFLAGS += -DMPPCFG_GPS_PACK_METHOD=0#OPTION_GPS_PACK_IN_TRACK
else ifeq ($(MPPCFG_GPS_PACK_IN_MDAT),Y)
  LOCAL_EXT_CFLAGS += -DMPPCFG_GPS_PACK_METHOD=1#OPTION_GPS_PACK_IN_MDAT
else
  LOCAL_EXT_CFLAGS += -DMPPCFG_GPS_PACK_METHOD=0
endif

#Extra flags to give to the C compiler
LOCAL_CFLAGS := $(CFLAGS) $(LOCAL_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function -Wno-unused-but-set-variable -DHAVE_AV_CONFIG_H
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(LOCAL_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function -Wno-unused-but-set-variable -DHAVE_AV_CONFIG_H
