# Makefile for eyesee-mpp/middleware/media/LIBRARY/libmuxer/common/libavutil
CUR_PATH := .
PACKAGE_TOP := ../../../../..
...
LOCAL_TARGET_STATIC := libffavutil
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libmuxer-common-libavutil done
	@echo ===================================
