# Makefile for eyesee-mpp/middleware/media/LIBRARY/libFsWriter
CUR_PATH := .
PACKAGE_TOP := ../../..
...
LOCAL_TARGET_STATIC := libFsWriter
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libFsWriter done
	@echo ===================================
