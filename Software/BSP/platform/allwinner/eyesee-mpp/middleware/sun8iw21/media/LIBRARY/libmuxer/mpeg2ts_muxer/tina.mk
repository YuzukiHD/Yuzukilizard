# Makefile for eyesee-mpp/middleware/media/LIBRARY/libmuxer/mpeg2ts_muxer
CUR_PATH := .
PACKAGE_TOP := ../../../..
...
LOCAL_TARGET_STATIC := libmpeg2ts_muxer
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libmuxer-mpeg2ts_muxer done
	@echo ===================================
