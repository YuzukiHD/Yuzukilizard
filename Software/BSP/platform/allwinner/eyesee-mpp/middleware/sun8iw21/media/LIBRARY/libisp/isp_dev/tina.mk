...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) -fPIC -Wall -rdynamic -Wno-unused-variable
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) -fPIC -Wall -rdynamic -Wno-unused-variable
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libisp-isp_dev done
	@echo ===================================
