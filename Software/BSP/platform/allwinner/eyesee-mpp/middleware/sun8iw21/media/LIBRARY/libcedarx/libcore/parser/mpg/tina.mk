# Makefile for eyesee-mpp/middleware/media/LIBRARY/libcedarx/libcore/parser/mpg
CUR_PATH := .
PACKAGE_TOP := ../../../../../..
...
LOCAL_TARGET_STATIC := libcdx_mpg_parser
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libcedarx-libcore-parser-mpg done
	@echo ===================================
