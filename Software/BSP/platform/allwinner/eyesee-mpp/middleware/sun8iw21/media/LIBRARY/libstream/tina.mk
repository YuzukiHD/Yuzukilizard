# Makefile for eyesee-mpp/middleware/media/LIBRARY/libstream
CUR_PATH := .
PACKAGE_TOP := ../../..
...
LOCAL_TARGET_DYNAMIC := libcedarxstream
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libcedarxstream
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function $(CEDARX_EXT_CFLAGS)
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-function $(CEDARX_EXT_CFLAGS)
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libstream done
	@echo ===================================
