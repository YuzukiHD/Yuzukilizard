...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_expand (short *s, char *law, short *sl) {
  long mant, iexp;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_subta (short *sl, short *se, short *d) {
  long se1;
  long sl1, sei, sli;
  short ses, sls;
...
/*
  ...
  --------------------------------------------------------------------------
*/
static void G726_log (short *d, short *dl, short *ds) {
  long mant;
  long d1;
  long dqm, exp_;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_quan (short rate, short *dln, short *ds, short *i) {
  if (rate == 4) {
    if (*dln >= 3972)
      *i = 1;
    else if (*dln >= 2048)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_subtb (short *dl, short *y, short *dln) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_adda (dqln, y, dql)
     short *dqln, *y, *dql;
{
  *dql = (*dqln + (*y >> 2)) & 4095;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_antilog (dql, dqs, dq)
     short *dql, *dqs, *dq;
{
  long dqmag;
  long ds, dmn, dex, dqt;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_reconst (short rate, short *i, short *dqln, short *dqs) {
  if (rate == 4) {
    /* Initialized data */
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_delaya (short *r, short *x, short *y) {
  *y = (*r == 0) ? *x : 0;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_delayb (short *r, short *x, short *y) {
  *y = (*r == 0) ? *x : 544;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_delayc (short *r, long *x, long *y) {
  *y = (*r == 0) ? *x : 34816;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_delayd (short *r, short *x, short *y) {
  *y = (*r == 0) ? *x : 32;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_filtd (short *wi, short *y, short *yut) {
  long difs, difsx;
  long y1;
  long wi1, dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_filte (short *yup, long *yl, long *ylp) {
  long difs, difsx;
  long dif, dif1, yup1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_functw (short rate, short *i, short *wi) {
  if (rate == 4) {
    /* Initialized data */
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_limb (short *yut, short *yup) {
  short gell, geul;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_mix (short *al, short *yu, long *yl, short *y) {
  long difm, difs, prod;
  long prodm, al1;
  long yu1, dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_filta (short *fi, short *dms, short *dmsp) {
  short difs, difsx;
  short dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_filtb (short *fi, short *dml, short *dmlp) {
  long difs, difsx;
  long fi1;
  long dif, dml1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_filtc (short *ax, short *ap, short *app) {
  short difs, difsx;
  short dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_functf (short rate, short *i, short *fi) {
  short im, is;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_lima (short *ap, short *al) {
  *al = (*ap >= 256) ? 64 : (*ap >> 2);
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_subtc (short *dmsp, short *dmlp, short *tdp, short *y, short *ax) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_triga (short *tr, short *app, short *apr) {
  *apr = (*tr == 0) ? (*app) : 256;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_accum (short *wa1, short *wa2, short *wb1, short *wb2, short *wb3, short *wb4, short *wb5, short *wb6, short *se, short *sez) {
  unsigned long sezi;
...
/*
 ----------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------
*/
static void G726_addb (short *dq, short *se, short *sr) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_addc (short *dq, short *sez, short *pk0, short *sigpk) {
  unsigned long sezi;
  short sezs;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_floata (short *dq, short *dq0) {
  long mant;
  long mag, exp_;
  long dqs;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_floatb (short *sr, short *sr0) {
  long mant;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_fmult (short *An, short *SRn, short *WAn) {
...
static void G726_limc (short *a2t, short *a2p) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_limd (short *a1t, short *a2p, short *a1p) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_trigb (short *tr, short *ap, short *ar) {
  *ar = (*tr == 0) ? *ap : 0;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_upa1 (short *pk0, short *pk1, short *a1, short *sigpk, short *a1t) {
  long a11, a1s, ua1;
  long ash;
  short pks;
  long uga1, ula1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_upa2 (short *pk0, short *pk1, short *pk2, short *a2, short *a1, short *sigpk, short *a2t) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_upb (short rate, short *u, short *b, short *dq, short *bp) {
  short dqmag;
  long bb, bs, ub;
  long ugb, ulb;
  short param;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_xor (short *dqn, short *dq, short *u) {
  short dqns;
  short dqs;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_tone (short *a2p, short *tdp) {
  long a2p1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_trans (short *td, long *yl, short *dq, short *tr) {
  short dqmag;
  long dqthr;
  short ylint;
  long dqmag1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_compress (short *sr, char *law, short *sp) {
...
/*
 ...
 ----------------------------------------------------------------------
*/
static void G726_sync (short rate, short *i, short *sp, short *dlnx, short *dsx, char *law, short *sd) {
