# Makefile for eyesee-mpp/middleware/media/LIBRARY/libmuxer/muxers
CUR_PATH := .
PACKAGE_TOP := ../../../..
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libmuxer-muxers done
	@echo ===================================
