...
int convertJpegToBmpData(FILE *inputFile, unsigned char *bmpData,
                         unsigned int *bmpWidth, unsigned int *bmpHeight) {
...
void *prepareImageDataForDisplay(char *name, unsigned int width,
                                 unsigned int height, unsigned int channels) {
  unsigned char *bmpData;

  bmpData = (unsigned char *)malloc(width * height * channels *
